...
Route::get('/all-customers','Customers@customers');
Route::get('/unactive-customers/{customerst_id}','Customers@unactive_customers');
Route::get('/active-customers/{customers_id}','Customers@active_customers');
