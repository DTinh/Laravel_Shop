...
class CheckoutController extends Controller
{
    ...
    public function add_customer(Request $request){
        ...
        $data['customers_status'] = $request->customers_status;
    ...
    public function order_place(Request $request){
        ...
        if($data['payment_method']==1){
            ...
            // $message->to($to_email)->subject('kiểm tra thử gửi mail google');//send this mail with
            // subject
    ...
    public function login_customer(Request $request){
        ...
        $result = DB::table('tbl_customers')->where('customer_email',$email)->where('customer_password',$password)->where('customers_status','0')->first();
