...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="tel:0337396024"><i class="fa fa-phone"></i> 0337396024</a></li>
                                <li><a href="mailto:tinhtd.21@vku.udn.vn"><i class="fa fa-envelope"></i> tinhtd.21@vku.udn.vn </a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/trang-chu')}}"><img src="{{('public/frontend/images/')}}" alt="" width="150px;" /></a>
                        </div>
  ...
  <footer class="footer-distributed">
            ...
            <div class="footer-left">
                ...
                <a href="{{URL::to('/trang-chu')}}"><h3>Duy Tính</h3></a>
                ...
                <p class="footer-company-name">Copy right © 2022 by Trần Duy Tính</p>
            </div>
            ...
            <div class="footer-center">
                ...
                <div>
                    <a href="tel:0337396024"><i class="fa fa-phone"></i></a>
                    <p>0337396024</p>
                </div>

                <div>
                    <a href="mailto:huyentt.vku.udn.vn"><i class="fa fa-envelope"></i></a>
                    <p>tinhtd.vku.udn.vn</p>
                </div>
